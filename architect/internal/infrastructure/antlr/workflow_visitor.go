...
type workflowVisitor struct {
	*workflow_generated.BaseWorkflowVisitor
	common *workflowCommonVisitor
	setErr func(error)
}

func newWorkflowVisitor(setErr func(error)) *workflowVisitor {
	visitor := &workflowVisitor{
		BaseWorkflowVisitor: &workflow_generated.BaseWorkflowVisitor{},
		setErr:              setErr,
	}

	visitor.common = newWorkflowCommonVisitor(setErr)

	return visitor
}

func (v *workflowVisitor) VisitAction(ctx *workflow_generated.ActionContext) interface{} {
	switch {
...
func (v *workflowVisitor) VisitFetchAction(ctx *workflow_generated.FetchActionContext) interface{} {
...
func (v *workflowVisitor) VisitCreateAction(ctx *workflow_generated.CreateActionContext) interface{} {
	variable, ok := ctx.TypedVariable().Accept(v).(workflows.TypedVariable)
	if !ok || variable == nil {
...
func (v *workflowVisitor) VisitStoreAction(ctx *workflow_generated.StoreActionContext) interface{} {
...
func (v *workflowVisitor) VisitUpdateAction(ctx *workflow_generated.UpdateActionContext) interface{} {
	assignments, ok := ctx.AssignmentBlock().Accept(v).([]workflows.Assignment)
	if !ok {
...
func (v *workflowVisitor) VisitEmitAction(ctx *workflow_generated.EmitActionContext) interface{} {
	variable, ok := ctx.TypedVariable().Accept(v).(workflows.TypedVariable)
	if !ok || variable == nil {
...
func (v *workflowVisitor) VisitCallAction(ctx *workflow_generated.CallActionContext) interface{} {
	assignments, ok := ctx.AssignmentBlock().Accept(v).([]workflows.Assignment)
	if !ok {
...
func (v *workflowVisitor) VisitReturnAction(ctx *workflow_generated.ReturnActionContext) interface{} {
...
func (v *workflowVisitor) VisitTypedVariable(ctx *workflow_generated.TypedVariableContext) interface{} {
...
func (v *workflowVisitor) VisitAssignmentBlock(ctx *workflow_generated.AssignmentBlockContext) interface{} {
...
func (v *workflowVisitor) VisitAssignment(ctx *workflow_generated.AssignmentContext) interface{} {
	expression, ok := ctx.Expression().Accept(v).(workflows.Expression)
	if !ok || expression == nil {
...
func (v *workflowVisitor) VisitCondition(ctx *workflow_generated.ConditionContext) interface{} {
...
func (v *workflowVisitor) VisitExpression(ctx *workflow_generated.ExpressionContext) interface{} {
...
func (v *workflowVisitor) VisitFunctionCall(ctx *workflow_generated.FunctionCallContext) interface{} {
...
func (v *workflowVisitor) VisitArgumentList(ctx *workflow_generated.ArgumentListContext) interface{} {
	args := make([]workflows.Expression, 0)
...
func (v *workflowVisitor) VisitSelector(ctx *workflow_generated.SelectorContext) interface{} {
...
func parseComparator(value string) workflows.Comparator {
	switch value {
	case "==":
		return workflows.ComparatorEqual
	case "!=":
		return workflows.ComparatorNotEqual
	case "<":
		return workflows.ComparatorLessThan
	case "<=":
		return workflows.ComparatorLessThanOrEqual
	case ">":
		return workflows.ComparatorGreaterThan
	case ">=":
		return workflows.ComparatorGreaterThanOrEqual
	default:
		return workflows.Comparator(value)
	}
}
